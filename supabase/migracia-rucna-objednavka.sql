-- Do srdiečka — ručne zapísaná objednávka
--
-- Do funkcie pribúda posledný parameter p_rucne. Keď je zapnutý, funkcia
...
--
-- Starú šesťparametrovú podobu treba najprv zahodiť, inak by v databáze
-- ostali dve funkcie s rovnakým menom a nebolo by jasné, ktorá sa volá.
--
-- Skript je bezpečné spustiť aj viackrát.

drop function if exists create_order(date, text, text, text, text, jsonb);
...
-- Práva: funkciu smie spúšťať iba náš server.
