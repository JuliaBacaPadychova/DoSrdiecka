...
children.push(table(
  ...
  [
    ...
    [["Pozrieť objednávky, označiť vybavenú alebo zrušenú"], [["Správa → Objednávky", true], ["Hore sú nové od najbližšieho termínu, pod nimi vybavené a naspodku zrušené. Zrušená objednávka automaticky uvoľní kapacitu dňa.", false, true]]],
    [["Zapísať objednávku dohodnutú mimo web"], [["Správa → Objednávky → Zapísať objednávku", true], ["Zaberie kapacitu dňa ako každá iná. Lehota na objednanie, minimálny odber ani otvorený deň sa tu neuplatňujú a zákazníčke neodíde e-mail. Keď termín v kalendári ešte nie je, pridá sa sám ako zatvorený — na webe sa teda neponúkne.", false, true]]],
    ...
    [["Zmeniť zvýraznenú poznámku pri ponuke"], [["Správa → Nastavenia → Zvýraznená poznámka pri ponuke", true], ["Teraz je tam veta o bezlaktózových surovinách. Zobrazuje sa vedľa nadpisu „Čo momentálne pečiem“.", false, true]]],
...
[
  ...
  ["hotovo", "Tri e-maily", "notifikácia tebe, potvrdenie zákazníčke a jeho kópia tebe — z tej odpovedáš priamo zákazníčke"],
  ["hotovo", "Denný limit chlebíka", "18 ks zákuskov, 1 torta, 1 chlebík na deň"],
  ["hotovo", "Ručný zápis objednávky", "aj na termín mimo kalendára; ten sa pridá ako zatvorený a kapacitu dňa objednávka zaberie rovnako"],
  ["hotovo", "Objednávky podľa stavu", "nové hore od najbližšieho termínu, vybavené a zrušené pod nimi"],
  ["hotovo", "Zmena hesla v správe", "nemusíš kvôli tomu chodiť do Supabase; aspoň 10 znakov"],
  ...
  ["hotovo", "Číslo objednávky", "v predmete e-mailov aj na potvrdzovacej obrazovke"],
  ...
  ["hotovo", "Presná adresa nie je na webe", "všade len Petržalka; ulicu posielaš sama, keď termín potvrdzuješ"],
